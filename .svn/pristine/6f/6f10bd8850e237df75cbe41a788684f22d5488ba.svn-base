...
describe Framework::Constants::CategoryTypesController, :type=>:controller do
  render_views
  ...
  describe "user logged in as root" do
    ...
    it "should create category type" do
      ...
      assert_redirected_to "/framework/constants/category_types/edit?id=" + language.to_param
    end
    ...
    it "should update category type" do
      post :update, :id => languages(:russian_language).to_param, :language => { }
      assert_not_nil flash[:notice]
      assert_redirected_to "/framework/constants/category_types/edit?id=" + languages(:russian_language).to_param
    end

    it "should destroy category type" do
      assert_difference('Language.count', -1) do
        delete :destroy, :id => languages(:russian_language).to_param
      end
      assert_redirected_to "/framework/constants/category_types"
    end
  end
end
