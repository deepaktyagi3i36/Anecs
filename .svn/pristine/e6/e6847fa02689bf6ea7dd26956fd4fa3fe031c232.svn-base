...
describe Backoffice::Settings::CurrenciesController, :type=>:controller do
  render_views
  ...
  describe "user logged in as root" do
    ...
    it "should create currency" do
      ...
      assert_redirected_to "/backoffice/settings/currencies/edit?id=" + currency.to_param
    end
    ...
    it "should update currency" do
      ...
      assert_not_nil flash[:notice]
      assert_redirected_to "/backoffice/settings/currencies/edit?id=" + currencies(:euro_currency).to_param
    end
    ...
    it "should destroy currency" do
      ...
      assert_redirected_to "/backoffice/settings/currencies"
    end
  end
end
