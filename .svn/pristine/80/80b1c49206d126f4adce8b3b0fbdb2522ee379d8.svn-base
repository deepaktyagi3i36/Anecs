...
describe Backoffice::Products::Products::PhotosController, :type=>:controller do
  render_views
  ...
  describe "user logged in as root" do
    ...
    it "should get index" do
      ...
      assert_select "form#images_filter"
    end
    ...
    it "should get index with filter" do
      get :index, :image_filter => { :photo_file_name => "", :product_id => "",
