...
describe Backoffice::Settings::LanguagesController, :type=>:controller do
  render_views
  ...
  describe "user logged in as root" do
    ...
    it "should create language" do
      ...
      assert_redirected_to "/backoffice/settings/languages/edit?id=" + language.to_param
    end
    ...
    it "should update language" do
      ...
      assert_not_nil flash[:notice]
      assert_redirected_to "/backoffice/settings/languages/edit?id=" + languages(:russian_language).to_param
    end
    ...
    it "should destroy language" do
      ...
      assert_redirected_to "/backoffice/settings/languages"
    end
  end
end
